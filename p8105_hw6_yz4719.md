...
``` r
# Fit a full model and perform stepwise regression
...
``` r
# Fit a linear model using only significant variables
...
![](p8105_hw6_yz4719_files/figure-gfm/unnamed-chunk-2-1.png)<!-- -->
...
# Pivoting and plotting RMSE for Model Comparison
cv_df |>
  pivot_longer(
...
![](p8105_hw6_yz4719_files/figure-gfm/unnamed-chunk-2-2.png)<!-- -->
